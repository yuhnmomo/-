...
const CharacterCreation: React.FC<CharacterCreationProps> = ({ onCreationComplete, maleAppearances, femaleAppearances }) => {
  return (
    <div className="flex items-center justify-center h-full w-full bg-black/50">
        <div className="flex flex-col h-full max-h-[95vh] w-full max-w-lg bg-[#20232c]/90 backdrop-blur-sm rounded-xl shadow-lg border border-white/10 p-6 m-4">
            <div className="text-center mb-6 flex-shrink-0">
                <h1 className="text-2xl font-bold text-white mb-2">🚂 創建您的角色</h1>
